        ...
        <div className="children-cards-grid">
          {products.length === 0 ? (
            ...
            products.map((product) => (
              <article key={product._id} className="children-product-card" style={{ position: 'relative' }}>
                ...
                <div className="children-product-details">
                  ...
                  <div className="children-product-pricing">
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                      ...
                      <span className="children-product-old-price">₹{product.oldPrice || product.price * 1.2}</span>
                    </div>
                    <button
                      type="button"
          ...
          <div className="children-popup-overlay" onClick={() => setSelectedProduct(null)}>
            <div className="children-popup" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="children-popup-pricing">
                ...
                <span className="children-popup-old-price">₹{selectedProduct.oldPrice || selectedProduct.price * 1.2}</span>
              </div>
